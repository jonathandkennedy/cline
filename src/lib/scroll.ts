import type { ScrollToTopBehavior } from '@/kit/layout/types/scroll';
...
export function scrollWindowToElement(
	element: HTMLElement,
	options?: { extraRem?: number; behavior?: ScrollToTopBehavior },
): void {
	const offset = stickyHeaderScrollOffsetPx(options?.extraRem ?? 1.5);
